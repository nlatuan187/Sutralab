      ...
      <div className="grid h-full gap-5">
        <div>
          <h2 className="mb-4 text-lg md:text-3xl font-semibold">
            Có câu hỏi về giải pháp của chúng tôi?
          </h2>
          <p className="mb-2 text-xs md:text-md text-gray-600">
            Hãy liên hệ với chúng tôi ngay!
          </p>
          <Button className="mt-3 rounded-2xl">Đặt Lịch Ngay</Button>
        </div>
        <div className="transition-all duration-500 ease-out md:group-hover:-right-12 md:group-hover:top-5">
          <div>
            <div className="h-full w-full max-w-[550px] rounded-[24px] border border-gray-200 p-2 transition-colors duration-100 group-hover:border-indigo-400">
              <div
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-xs text-gray-500">Cuộc gọi 30 phút</p>
                </div>
...
export function BentoCard({
  ...
  const cardContent = (
    <div
      className={`group relative flex flex-col rounded-2xl border border-gray-200 bg-white dark:bg-gray-900 p-6 hover:bg-indigo-100/10 dark:hover:bg-indigo-900/10 ${
